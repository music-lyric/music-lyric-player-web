...
- **Settings tab** — live editor for the DOM player config (layout, scroll animation, effects, line styles, syllable / annotation / interlude rendering). Auto-saves to `localStorage`
